...
# 诗词/poems/poem_admin.py → 仓库根
SITE_ROOT = Path(__file__).resolve().parents[2]
FEATURE_DATA = Path(__file__).resolve().parents[1] / "数据"
LEGACY_POEM_ROOT = SITE_ROOT / "脚本" / "旧项目" / "poem-20260313"
...
def ensure_poem_data() -> None:
    ...
    bundled_poem = FEATURE_DATA / POEM_FILE_NAME
    bundled_stories = FEATURE_DATA / STORIES_FILE_NAME
