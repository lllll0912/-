...
与网站版共用仓库根目录 data/water_data.json（可用 BILL_DATA_DIR 覆盖）。
"""
...
class DataStore:
    def __init__(self, path: Optional[Path] = None) -> None:
        self.path = path or _shared_data_file()
